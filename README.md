...
Browser-native interactive demos for constraint theory and fleet visualization. No install. Just open in Chrome.
...
| [PLATO Client](https://superinstance.github.io/cocapn-ai-web/demo-plato-client.html) | PLATO room protocol and tile visualization |

All demos are self-contained HTML — zero dependencies, zero build step. Open directly in any browser.
